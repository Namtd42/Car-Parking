			...
			<div class="col-md-10 border border-success">
				<div class="p-4">
					...
					<form action="<%=request.getContextPath()%>/add_employee"
						method="post" class="form-group" name="addEmployeeForm"
						...
						<table class="table table-borderless">
							...
							<tr>
								<td><b>Sex(*)</b></td>
								<td><input type="radio" name="sex" id="sex" value="male"><b>Male</b>
									<input type="radio" name="sex" id="sex" value="female" class="ml-2"><b>Female</b>
								</td>
							</tr>
							<tr>
								<td><b>Address</b></td>
